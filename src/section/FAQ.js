  ...
  return (
    <div className='p-5 my-5 container text-center bg-dark'>
        ...
        <div className='px-sm-5 pb-5'>
          ...
          <Accordion title="How many whitelist spots will be available?" children={<p><span className='bold'>The Brokers</span> will have 111 whitelist spots to get your NFTs at the lower price. This is the 1st out of our multiple phases on our Roadmap.</p>} />
